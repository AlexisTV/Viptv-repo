...
ORDER          = ['anarchy', 'bubbles', 'covenant', 'death', 'exodus', 'exoshark', 'gurzil', 'metalliq', 'notsure', 'piranha', 'poseidon', 'resistance', 'salts', 'saltshd', 'saltsrd', 'specto', 'streamhub', 'thedelorean', 'trakt', 'ugottoc', 'wtfork']
